...
<body>
    <div class="container">
        ...
        <div class="control-section">
            ...
            <div id="connectionStatus">
                ...
                <span id="statusText">Disconnected from AGV</span>
            </div>
        </div>
    ...
    <script>
        ...
        function connect() {
            ...
            ws.onopen = function() {
                isConnected = true;
                updateConnectionStatus(true, 'Connected to AGV');
                addLog('✅ Connected to AGV');
                updateAGVStatus('Connected - Ready for commands');
            };
            
            ws.onclose = function() {
                isConnected = false;
                updateConnectionStatus(false, 'Disconnected from AGV');
